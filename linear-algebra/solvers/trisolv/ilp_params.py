...
loop_vars = ['c0_b0', 'c0_b1', 'c1_b1']  # 循环变量列表
...
block_array_layout = {
    0: {
        ...
        'b': 'row_major',  # 1D array, dims: c0_b0
        'x': 'row_major',  # 1D array, dims: c0_b0
    },
    1: {
        # Multi-dimensional arrays
        'L': 'row_major',  # 2D array, dims: c0_b1, c1_b1
        # One-dimensional arrays
        'x': 'row_major',  # 1D array, dims: c0_b1, c1_b1
    },
}
...
T_op1 = 10.4  # Statement 1 cost (block 0)
T_op2 = 19.22  # Statement 2 cost (block 1)
T_op3 = 15.59  # Statement 3 cost (block 1)
...
T_L2 = 7.34  # L2 cache access latency
...
block_0_objective = "4000 * 10.40"
block_1_objective = "c0_b1_blocks * c1_b1_blocks * c1_b1_tile * 19.22 + c0_b1_blocks * 15.59"
...
block_1_read_only_constraint = "(c0_b1_tile * c1_b1_tile * data_size + c0_b1_tile * c0_b1_tile * data_size)"
block_1_l1_lower_constraint = "(c0_b1_tile * data_size + c1_b1_tile * data_size) > L1_size"
block_1_l2_upper_constraint = "(c0_b1_tile * data_size + c1_b1_tile * data_size) <= L2_size"
block_1_read_write_constraint = "(c0_b1_tile * data_size + c1_b1_tile * data_size)"

# Global constraints (aggregated across all blocks)
read_only_constraint = "(data_size ) + (c0_b1_tile * c1_b1_tile * data_size + c0_b1_tile * c0_b1_tile * data_size)"
read_write_l1_constraint = "(data_size) + (c0_b1_tile * data_size + c1_b1_tile * data_size) > L1_size"
read_write_l2_constraint = "(data_size ) + (c0_b1_tile * data_size + c1_b1_tile * data_size) <= L2_size"
read_write_constraint = "(data_size ) + (c0_b1_tile * data_size + c1_b1_tile * data_size)"

# # Block 1 specific constraints
# block_1_read_only_constraint = "(c0_b1_tile * c1_b1_tile * data_size + c0_b1_tile * c0_b1_tile * data_size)+ (c0_b1_tile * data_size + c1_b1_tile * data_size) "
# block_1_l1_lower_constraint = None
# block_1_l2_upper_constraint = None
# block_1_read_write_constraint = None

# # Global constraints (aggregated across all blocks)
# read_only_constraint = "(data_size + data_size) + (c0_b1_tile * c1_b1_tile * data_size + c0_b1_tile * c0_b1_tile * data_size)+  + (c0_b1_tile * data_size + c1_b1_tile * data_size)"
# read_write_l1_constraint = "(data_size + data_size) > L1_size"
# read_write_l2_constraint = "(data_size + data_size) <= L2_size"
# read_write_constraint = "(data_size + data_size)"

# Auto-generated objective function
objective_function = "(4000 * 10.40) + (c0_b1_blocks * c1_b1_blocks * c1_b1_tile * 19.22 + c0_b1_blocks * 15.59)"

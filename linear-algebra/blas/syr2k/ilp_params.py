...
loop_vars = ['c0_b0', 'c1_b0', 'c0_b1', 'c1_b1', 'c2_b1']  # 循环变量列表
...
block_array_layout = {
    ...
    1: {
        # Multi-dimensional arrays
        'A': 'row_major',  # 2D array, dims: c0_b1, c1_b1, c2_b1
        'B': 'row_major',  # 2D array, dims: c0_b1, c1_b1, c2_b1
        'C': 'row_major',  # 2D array, dims: c0_b1, c1_b1
    },
}
...
T_op2 = 26.310000000000002  # Statement 2 cost (block 1)
...
block_0_objective = "c0_b0_blocks * c1_b0_blocks * 7.35"
block_1_objective = "c0_b1_blocks * c1_b1_blocks * c2_b1_blocks * 26.31"

# Combined cache constraints for ILP model
# Cache constraints for ILP model

# Block 0 specific constraints
block_0_read_only_constraint = "c0_b0_tile * c1_b0_tile * data_size"
...
block_1_read_only_constraint = "c0_b1_tile * c1_b1_tile * data_size + (c1_b1_tile * c2_b1_tile * data_size + c0_b1_tile * c2_b1_tile * data_size) + (c0_b1_tile * c2_b1_tile * data_size + c1_b1_tile * c2_b1_tile * data_size)"
...
read_only_constraint = "c0_b0_tile * c1_b0_tile * data_size + c0_b1_tile * c1_b1_tile * data_size + (c1_b1_tile * c2_b1_tile * data_size + c0_b1_tile * c2_b1_tile * data_size) + (c0_b1_tile * c2_b1_tile * data_size + c1_b1_tile * c2_b1_tile * data_size)"
read_write_l1_constraint = None
read_write_l2_constraint = None
read_write_constraint = None

# Tile size constraints
tile_size_constraints = [
    ("c0_b0", ">=", "c1_b0"),   # c0 的分块必须大于 c1
    ("c0_b1", ">=", "c1_b1"),    # i 的分块必须大于等于 j
    # ("m_b2", "==", "n_b2"),    # m 和 n 必须使用相同的分块大小
]

# Auto-generated objective function
objective_function = "(c0_b0_blocks * c1_b0_blocks * 7.35) + (c0_b1_blocks * c1_b1_blocks * c2_b1_blocks * 26.31)"

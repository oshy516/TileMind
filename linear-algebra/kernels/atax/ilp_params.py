...
loop_vars = ['c0_b0', 'c0_b1', 'c1_b1', 'c0_b2', 'c0_b3', 'c1_b3']  # 循环变量列表

# 循环变量尺寸
c0_b0_size = 1  # Non-tileable dimension
c0_b1_size = 1800  # Loop variable c0 in block 1
c1_b1_size = 2200  # Loop variable c1 in block 1
...
block_array_layout = {
    ...
    3: {
        # Multi-dimensional arrays
        'A': 'column_major',  # 2D array, dims: c0_b3, c1_b3
        # One-dimensional arrays
        'tmp': 'row_major',  # 1D array, dims: c1_b3
...
T_op1 = 8.91  # Statement 1 cost (block 0)
T_op2 = 19.3  # Statement 2 cost (block 1)
T_op3 = 8.91  # Statement 3 cost (block 2)
T_op4 = 24.15  # Statement 4 cost (block 3)
...
T_L1 = 4.06  # L1 cache access latency
T_L2 = 8.91  # L2 cache access latency

# Operation latencies (nanoseconds)
T_add = 0.78  # Double addition latency
T_sub = 0.74  # Double subtraction latency
T_mul = 1.49  # Double multiplication latency
T_div = 5.44  # Double division latency
...
block_0_objective = "1800 * 8.91"
block_1_objective = "c0_b1_blocks * c1_b1_blocks * 19.30"
block_2_objective = "2200 * 8.91"
block_3_objective = "c0_b3_blocks * c1_b3_blocks * 24.15"
...
# Block 1 specific constraints->L1
...
# # Block 3 specific constraints y+tmp->L2
# block_3_read_only_constraint = "c1_b3_tile * c0_b3_tile * data_size"
# block_3_l1_lower_constraint = "c0_b3_tile * data_size + c1_b3_tile * data_size > L1_size"
# block_3_l2_upper_constraint = "c0_b3_tile * data_size + c1_b3_tile * data_size <= L2_size"
# block_3_read_write_constraint = "c0_b3_tile * data_size + c1_b3_tile * data_size"

# Block 3 specific constraints y+tmp->L1
block_3_read_only_constraint = "c1_b3_tile * c0_b3_tile * data_size + c0_b3_tile * data_size + c1_b3_tile * data_size"
...
# read_only_constraint = "c0_b1_tile * c1_b1_tile * data_size + c1_b1_tile * data_size + c1_b3_tile * c0_b3_tile * data_size"
# read_write_l1_constraint = "data_size + c0_b1_tile * data_size + data_size + c0_b3_tile * data_size + c1_b3_tile * data_size > L1_size"
# read_write_l2_constraint = "data_size + c0_b1_tile * data_size + data_size + c0_b3_tile * data_size + c1_b3_tile * data_size <= L2_size"
# read_write_constraint = "data_size + c0_b1_tile * data_size + data_size + c0_b3_tile * data_size + c1_b3_tile * data_size"

# Auto-generated objective function
objective_function = "(1800 * 8.91) + (c0_b1_blocks * c1_b1_blocks * 19.30) + (2200 * 8.91) + (c0_b3_blocks * c1_b3_blocks * 24.15)"

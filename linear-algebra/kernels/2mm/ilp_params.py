...
# 循环变量尺寸
c0_b0_size = 1600  # Loop variable c0 in block 0
c1_b0_size = 1800  # Loop variable c1 in block 0
c2_b0_size = 2200  # Loop variable c2 in block 0
c0_b1_size = 1600  # Loop variable c0 in block 1
c1_b1_size = 2400  # Loop variable c1 in block 1
c2_b1_size = 1800  # Loop variable c2 in block 1
...
block_array_layout = {
    0: {
        ...
        'tmp': 'row_major',  # 2D array, dims: c0_b0, c1_b0
    },
    1: {
        # Multi-dimensional arrays
        'C': 'column_major',  # 2D array, dims: c1_b1, c2_b1
        'D': 'row_major',  # 2D array, dims: c0_b1, c1_b1
        'tmp': 'row_major',  # 2D array, dims: c0_b1, c2_b1
    },
}
...
T_op1 = 7.35  # Statement 1 cost (block 0)
T_op2 = 16.47  # Statement 2 cost (block 0)
T_op3 = 7.35  # Statement 3 cost (block 1)
T_op4 = 19.26  # Statement 4 cost (block 1)
...
block_0_objective = "c0_b0_blocks * c1_b0_blocks * c2_b0_blocks* 7.35 + c0_b0_blocks * c1_b0_blocks * c2_b0_blocks * c2_b0_tile * 16.47"
block_1_objective = "c0_b1_blocks * c1_b1_blocks * c2_b1_blocks * 7.35 + c0_b1_blocks * c1_b1_blocks * c2_b1_blocks * c2_b1_tile * 19.26"
...
block_1_read_only_constraint = "c2_b1_tile * c1_b1_tile * data_size"
block_1_l1_lower_constraint = "c0_b1_tile * c1_b1_tile * data_size + c0_b1_tile * c2_b1_tile * data_size > L1_size"
block_1_l2_upper_constraint = "c0_b1_tile * c1_b1_tile * data_size + c0_b1_tile * c2_b1_tile * data_size <= L2_size"
block_1_read_write_constraint = "c0_b1_tile * c1_b1_tile * data_size + c0_b1_tile * c2_b1_tile * data_size"

# Global constraints (aggregated across all blocks)
read_only_constraint = "c0_b0_tile * c2_b0_tile * data_size + c2_b0_tile * c1_b0_tile * data_size + c2_b1_tile * c1_b1_tile * data_size"
read_write_l1_constraint = "c0_b0_tile * c1_b0_tile * data_size + c0_b1_tile * c1_b1_tile * data_size + c0_b1_tile * c2_b1_tile * data_size > L1_size"
read_write_l2_constraint = "c0_b0_tile * c1_b0_tile * data_size + c0_b1_tile * c1_b1_tile * data_size + c0_b1_tile * c2_b1_tile * data_size <= L2_size"
read_write_constraint = "c0_b0_tile * c1_b0_tile * data_size + c0_b1_tile * c1_b1_tile * data_size + c0_b1_tile * c2_b1_tile * data_size"

# Auto-generated objective function
objective_function = "(c0_b0_blocks * c1_b0_blocks * c2_b0_blocks * 7.35 + c0_b0_blocks * c1_b0_blocks * c2_b0_blocks * c2_b0_tile * 16.47) + (c0_b1_blocks * c1_b1_blocks * c2_b1_blocks * 7.35 + c0_b1_blocks * c1_b1_blocks * c2_b1_blocks * c2_b1_tile * 19.26)"

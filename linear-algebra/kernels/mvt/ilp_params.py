...
loop_vars = ['c0_b0', 'c1_b0', 'c0_b1', 'c1_b1']  # 循环变量列表
...
block_array_layout = {
    0: {
        ...
        'x1': 'row_major',  # 1D array, dims: c0_b0
        'y_1': 'row_major',  # 1D array, dims: c1_b0
    },
    1: {
        # Multi-dimensional arrays
        'A': 'column_major',  # 2D array, dims: c0_b1, c1_b1
        # One-dimensional arrays
        'x2': 'row_major',  # 1D array, dims: c0_b1
        'y_2': 'row_major',  # 1D array, dims: c1_b1
    },
}
...
T_op1 = 15.74  # Statement 1 cost (block 0)
T_op2 = 15.74  # Statement 2 cost (block 1)
...
T_L2 = 7.36  # L2 cache access latency
...
block_0_objective = "c0_b0_blocks * c1_b0_blocks * 15.74"
block_1_objective = "c0_b1_blocks * c1_b1_blocks * 15.74"

# Combined cache constraints for ILP model
# Cache constraints for ILP model

# Block 0 specific constraints
block_0_read_only_constraint = "c0_b0_tile * c1_b0_tile * data_size + c1_b0_tile * data_size"
block_0_l1_lower_constraint = "c0_b0_tile * data_size > L1_size"
block_0_l2_upper_constraint = "c0_b0_tile * data_size <= L2_size"
block_0_read_write_constraint = "c0_b0_tile * data_size"

# Block 1 specific constraints
block_1_read_only_constraint = "c1_b1_tile * c0_b1_tile * data_size + c1_b1_tile * data_size"
...
read_only_constraint = "c0_b0_tile * c1_b0_tile * data_size + c1_b0_tile * data_size + c1_b1_tile * c0_b1_tile * data_size + c1_b1_tile * data_size"
read_write_l1_constraint = "c0_b0_tile * data_size + c0_b1_tile * data_size > L1_size"
read_write_l2_constraint = "c0_b0_tile * data_size + c0_b1_tile * data_size <= L2_size"
read_write_constraint = "c0_b0_tile * data_size + c0_b1_tile * data_size"

# Auto-generated objective function
objective_function = "(c0_b0_blocks * c1_b0_blocks * 15.74) + (c0_b1_blocks * c1_b1_blocks * 15.74)"
